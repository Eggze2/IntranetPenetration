...
CPoint CWatchDialog::UserPoint2RemoteScreenPoint(CPoint& point, bool isScreen)
{
	...
	TRACE(_T("x = %d , y = %d\r\n"), point.x, point.y);
	m_picture.GetWindowRect(clientRect);	// 获取客户端区域800x500
	int width = m_nObjWidth;
	int height = m_nObjHeight;
	return CPoint(point.x * width / clientRect.Width(), point.y * height / clientRect.Height());
}
